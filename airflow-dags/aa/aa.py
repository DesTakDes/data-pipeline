...
# Workflow  : aa
# DAG ID    : aa
# Generated : 2026-07-15T16:36:03.754529
# ─────────────────────────────────────────────────────────────────────────────
...
# ── Import task modules ───────────────────────────────────────────────────────
from tasks.task_task_5001 import run as run_task_5001

DAG_ID      = 'aa'
WORKFLOW_ID = 'wf_1784128896295_vhg7'
...
with DAG(
    ...
    catchup          = False,
    max_active_tasks = 4,
    tags             = ["etl", "workflow", 'wf_1784128896295_vhg7'],
    description      = '',
) as dag:
    ...
    task_5001_op = PythonOperator(
        task_id             = 'task_5001',
        python_callable     = lambda **ctx: run_task_5001(
    ...
    airflow_tasks['task_5001'] = task_5001_op
