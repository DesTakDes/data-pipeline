# Auto-generated Spark DAG: masasih
# Workflow: masasih
# Generated: 2026-05-26T02:52:50.880680
...
DAG_ID      = 'masasih'
INPUT_TABLE = 'staging.customers_1'
WORKFLOW_ID = 'wf_1779763928137_s2fi'
TASKS_DEF   = json.loads('[{"task_id": "task_2614", "output_name": "1", "transforms": [{"type": "fill_null", "config": {"columns": ["customerid", "gender", "age", "annual_income_($)", "spending_score_(1_100)", "profession", "work_experience", "family_size"], "fillValue": "", "fillType": "mean"}}], "depends_on": []}]')
...
with DAG(
    ...
    catchup=False,
    tags=["etl", "spark", "generated", 'wf_1779763928137_s2fi'],
    description='',
) as dag:
    airflow_tasks = {}
