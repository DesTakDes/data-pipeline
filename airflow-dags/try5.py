# Auto-generated Spark DAG: try5
# Workflow: try5
# Generated: 2026-05-26T06:55:08.810698
...
WORKFLOW_ID = 'wf_1779778476684_b9mu'
TASKS_DEF   = json.loads('[{"task_id": "task_1789", "output_name": "1", "transforms": [{"type": "drop_col", "config": {"columns": ["customerid"]}}], "depends_on": []}]')
...
with DAG(
    ...
    catchup=False,
    tags=["etl", "spark", "generated", 'wf_1779778476684_b9mu'],
    description='',
) as dag:
    airflow_tasks = {}
