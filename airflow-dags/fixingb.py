# Auto-generated Spark DAG: fixingb
# Workflow: fixinGB
# Generated: 2026-06-09T01:47:15.872263
...
WORKFLOW_ID = 'wf_1780969555271_p97i'
TASKS_DEF   = json.loads('[{"task_id": "task_1204", "output_name": "fixingb1", "transforms": [{"type": "drop_col", "config": {"columns": ["transaction_id"]}}], "depends_on": []}]')
...
with DAG(
    ...
    catchup=False,
    tags=["etl", "spark", "generated", 'wf_1780969555271_p97i'],
    description='',
) as dag:
    airflow_tasks = {}
