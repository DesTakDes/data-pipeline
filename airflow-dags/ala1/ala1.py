...
# Workflow  : ala1
# DAG ID    : ala1
# Generated : 2026-07-23T11:41:21.524052
# ─────────────────────────────────────────────────────────────────────────────
...
# ── Import task modules ───────────────────────────────────────────────────────
from tasks.task_task_0904 import run as run_task_0904

DAG_ID      = 'ala1'
WORKFLOW_ID = 'wf_1784806817582_20gt'
...
with DAG(
    ...
    catchup          = False,
    max_active_tasks = 4,
    tags             = ["etl", "workflow", 'wf_1784806817582_20gt'],
    description      = '',
) as dag:
    ...
    task_0904_op = PythonOperator(
        task_id             = 'task_0904',
        python_callable     = lambda **ctx: run_task_0904(
    ...
    airflow_tasks['task_0904'] = task_0904_op
