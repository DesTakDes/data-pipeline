# Auto-generated Spark DAG: fixin
# Workflow: fixin
# Generated: 2026-06-09T01:43:10.354121
...
DAG_ID      = 'fixin'
INPUT_TABLE = 'staging.shopping_behavior_updated_2'
WORKFLOW_ID = 'wf_1780969065466_b2sq'
TASKS_DEF   = json.loads('[{"task_id": "task_0643", "output_name": "fixin1", "transforms": [{"type": "rename_col", "config": {"renames": {"age": "umur", "gender": "kelamin"}}}], "depends_on": []}, {"task_id": "task_1306", "output_name": "fixin2", "transforms": [{"type": "drop_col", "config": {"columns": ["index", "url", "zip_code"]}}], "depends_on": []}]')
...
with DAG(
    ...
    catchup=False,
    tags=["etl", "spark", "generated", 'wf_1780969065466_b2sq'],
    description='',
) as dag:
    airflow_tasks = {}
