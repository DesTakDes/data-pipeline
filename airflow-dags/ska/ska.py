...
# Workflow  : ska
# DAG ID    : ska
# Generated : 2026-07-23T12:52:56.329017
# ─────────────────────────────────────────────────────────────────────────────
...
# ── Import task modules ───────────────────────────────────────────────────────
from tasks.task_task_7318 import run as run_task_7318

DAG_ID      = 'ska'
WORKFLOW_ID = 'wf_1784811119411_vcjy'
...
with DAG(
    ...
    catchup          = False,
    max_active_tasks = 4,
    tags             = ["etl", "workflow", 'wf_1784811119411_vcjy'],
    description      = '',
) as dag:
    ...
    task_7318_op = PythonOperator(
        task_id             = 'task_7318',
        python_callable     = lambda **ctx: run_task_7318(
    ...
    airflow_tasks['task_7318'] = task_7318_op
