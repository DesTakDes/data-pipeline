...
# Workflow  : lompat
# DAG ID    : lompat
# Generated : 2026-07-05T14:05:24.668674
# ─────────────────────────────────────────────────────────────────────────────
...
# ── Import task modules ───────────────────────────────────────────────────────
from tasks.task_task_1839 import run as run_task_1839

DAG_ID      = 'lompat'
WORKFLOW_ID = 'wf_1783260280561_boo4'
...
with DAG(
    ...
    catchup          = False,
    max_active_tasks = 4,
    tags             = ["etl", "workflow", 'wf_1783260280561_boo4'],
    description      = '',
) as dag:
    ...
    task_1839_op = PythonOperator(
        task_id             = 'task_1839',
        python_callable     = lambda **ctx: run_task_1839(
    ...
    airflow_tasks['task_1839'] = task_1839_op
