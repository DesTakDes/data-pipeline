# Auto-generated Spark DAG: cobaduls1
# Workflow: cobaduls1
# Generated: 2026-05-26T03:49:23.573849
...
WORKFLOW_ID = 'wf_1779767278991_36sd'
TASKS_DEF   = json.loads('[{"task_id": "task_7404", "output_name": "1", "transforms": [{"type": "drop_col", "config": {"columns": ["index", "url", "zip_code"]}}], "depends_on": []}]')
...
with DAG(
    ...
    catchup=False,
    tags=["etl", "spark", "generated", 'wf_1779767278991_36sd'],
    description='',
) as dag:
    airflow_tasks = {}
