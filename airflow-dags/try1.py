# Auto-generated Spark DAG: try1
# Workflow: try1
# Generated: 2026-05-26T05:55:02.616007
...
WORKFLOW_ID = 'wf_1779774867349_kiwo'
TASKS_DEF   = json.loads('[{"task_id": "task_5536", "output_name": "1", "transforms": [{"type": "drop_col", "config": {"columns": ["index", "url"]}}], "depends_on": []}]')
...
with DAG(
    ...
    catchup=False,
    tags=["etl", "spark", "generated", 'wf_1779774867349_kiwo'],
    description='',
) as dag:
    airflow_tasks = {}
