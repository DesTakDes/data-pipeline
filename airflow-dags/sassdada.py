# Auto-generated DAG: sassdada
# Workflow : sassdada
# Generated: 2026-06-25T05:46:38.876351
...
WORKFLOW_ID = 'wf_1782365735122_bos7'
TASKS_DEF   = json.loads('[{"task_id": "task_1623", "output_name": "lassa", "transforms": [{"type": "filter_rows", "config": {"formula": "spending_score_(1_100)>= 45"}}], "depends_on": []}]')
...
with DAG(
    ...
    catchup          = False,
    max_active_tasks = 4,
    tags             = ["etl","duckdb","smart",'wf_1782365735122_bos7'],
    description      = '',
) as dag:
    airflow_tasks = {}
