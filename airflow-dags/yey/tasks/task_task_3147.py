...
# Task ID   : task_3147
# DAG ID    : yey
# Output    : warehouse.akhirnya
# Generated : 2026-07-24T01:39:10.694400
# ─────────────────────────────────────────────────────────────────────────────
...
OUTPUT_NAME = 'akhirnya'
TRANSFORMS  = json.loads('[{"type": "join_data", "config": {"joinType": "INNER JOIN", "leftCol": "store_id", "rightCol": "store_id", "rightNodeId": "n1784856979192_2_49b1", "rightTable": "staging.market_sales_500"}}]')
