...
# Task ID   : task_5138
# DAG ID    : mamamia
# Output    : warehouse.mamamia2
# Generated : 2026-07-08T10:28:26.556594
# ─────────────────────────────────────────────────────────────────────────────
# This file contains ALL transform logic for this task.
# It is imported by the workflow DAG file (dag_mamamia.py).
# ─────────────────────────────────────────────────────────────────────────────
...
OUTPUT_NAME = 'mamamia2'
TRANSFORMS  = json.loads('[{"type": "drop_col", "config": {"columns": ["store_id", "store_name", "latitude", "longitude"]}}]')
