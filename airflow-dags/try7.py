# Auto-generated Spark DAG: try7
# Workflow: try7
# Generated: 2026-05-27T14:42:09.880764
...
WORKFLOW_ID = 'wf_1779892633989_nr8d'
TASKS_DEF   = json.loads('[{"task_id": "task_3695", "output_name": "test1", "transforms": [{"type": "drop_col", "config": {"columns": ["transaction_id"]}}], "depends_on": []}, {"task_id": "task_4750", "output_name": "test2", "transforms": [{"type": "drop_col", "config": {"columns": ["index", "url"]}}], "depends_on": []}]')
...
with DAG(
    ...
    catchup=False,
    tags=["etl", "spark", "generated", 'wf_1779892633989_nr8d'],
    description='',
) as dag:
    airflow_tasks = {}
