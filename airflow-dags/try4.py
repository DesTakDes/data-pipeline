# Auto-generated Spark DAG: try4
# Workflow: try4
# Generated: 2026-05-26T06:41:23.797757
...
WORKFLOW_ID = 'wf_1779777634945_n4gj'
TASKS_DEF   = json.loads('[{"task_id": "task_8379", "output_name": "1", "transforms": [{"type": "drop_col", "config": {"columns": ["index"]}}], "depends_on": []}]')
...
with DAG(
    ...
    catchup=False,
    tags=["etl", "spark", "generated", 'wf_1779777634945_n4gj'],
    description='',
) as dag:
    airflow_tasks = {}
