...
# Workflow  : cekin
# DAG ID    : cekin
# Generated : 2026-07-14T05:49:15.230329
# ─────────────────────────────────────────────────────────────────────────────
...
# ── Import task modules ───────────────────────────────────────────────────────
from tasks.task_task_6044 import run as run_task_6044

DAG_ID      = 'cekin'
WORKFLOW_ID = 'wf_1784007312993_tji9'
...
with DAG(
    ...
    catchup          = False,
    max_active_tasks = 4,
    tags             = ["etl", "workflow", 'wf_1784007312993_tji9'],
    description      = '',
) as dag:
    ...
    task_6044_op = PythonOperator(
        task_id             = 'task_6044',
        python_callable     = lambda **ctx: run_task_6044(
    ...
    airflow_tasks['task_6044'] = task_6044_op
