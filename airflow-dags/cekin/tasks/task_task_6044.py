...
# Task ID   : task_6044
# DAG ID    : cekin
# Output    : warehouse.join
# Generated : 2026-07-14T05:49:15.232616
# ─────────────────────────────────────────────────────────────────────────────
# This file contains ALL transform logic for this task.
# It is imported by the workflow DAG file (dag_cekin.py).
# ─────────────────────────────────────────────────────────────────────────────
...
OUTPUT_NAME = 'join'
TRANSFORMS  = json.loads('[{"type": "fill_null", "config": {"columns": ["store_id", "store_name", "city", "state", "latitude", "longitude"], "fillValue": "Unknown", "fillType": "value"}}, {"type": "join_data", "config": {"joinType": "INNER JOIN", "leftCol": "store_id", "rightCol": "store_id", "rightNodeId": "n1784007322577_2_kbof", "rightTable": "staging.market_sales_500"}}]')
