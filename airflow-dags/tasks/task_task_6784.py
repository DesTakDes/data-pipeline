...
# Task ID   : task_6784
# DAG ID    : cobaterus
# Output    : warehouse.ayo_2
# Generated : 2026-06-29T05:53:27.255036
# ─────────────────────────────────────────────────────────────────────────────
...
OUTPUT_NAME = 'ayo_2'
TRANSFORMS  = json.loads(r"""[{"type": "drop_col", "config": {"columns": ["index", "url", "zip_code", "phone_number_1", "phone_number_2", "fax_1", "fax_2", "email_1", "email_2", "website", "facebook", "twitter", "instagram", "pinterest", "youtube"]}}]""")
