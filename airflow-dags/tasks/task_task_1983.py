...
# Task ID   : task_1983
# DAG ID    : damb
# Output    : warehouse.damb_2
# Generated : 2026-06-29T03:14:12.441914
# ─────────────────────────────────────────────────────────────────────────────
...
OUTPUT_NAME = 'damb_2'
TRANSFORMS  = json.loads('[{"type": "drop_col", "config": {"columns": ["index", "customer_id", "last_name", "phone_1", "phone_2", "email", "website"]}}]')
