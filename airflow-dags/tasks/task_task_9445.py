...
# Task ID   : task_9445
# DAG ID    : damb
# Output    : warehouse.damb_1
# Generated : 2026-06-29T03:14:12.441730
# ─────────────────────────────────────────────────────────────────────────────
# This file contains ALL transform logic for this task.
# It is imported by the workflow DAG file (dag_damb.py).
# ─────────────────────────────────────────────────────────────────────────────
...
OUTPUT_NAME = 'damb_1'
TRANSFORMS  = json.loads('[{"type": "drop_col", "config": {"columns": ["index", "url", "zip_code", "phone_number_1", "phone_number_2", "fax_1", "fax_2", "email_1", "email_2", "website", "facebook", "twitter", "instagram", "pinterest", "youtube"]}}]')
