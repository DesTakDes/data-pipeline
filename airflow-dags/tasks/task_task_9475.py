...
# Task ID   : task_9475
# DAG ID    : tanam
# Output    : warehouse.mesin_1
# Generated : 2026-06-29T02:07:47.748767
# ─────────────────────────────────────────────────────────────────────────────
# This file contains ALL transform logic for this task.
# It is imported by the workflow DAG file (dag_tanam.py).
# ─────────────────────────────────────────────────────────────────────────────
...
TASK_ID     = 'task_9475'
DAG_ID      = 'tanam'
INPUT_TABLE = 'staging.market_sales_500'
OUTPUT_NAME = 'mesin_1'
TRANSFORMS  = json.loads('[{"type": "drop_col", "config": {"columns": ["sale_id", "store_id"]}}]')
