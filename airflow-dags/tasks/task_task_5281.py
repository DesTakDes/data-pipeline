...
# Task ID   : task_5281
# DAG ID    : bayam
# Output    : warehouse.bayam_2
# Generated : 2026-06-29T02:29:02.132441
# ─────────────────────────────────────────────────────────────────────────────
# This file contains ALL transform logic for this task.
# It is imported by the workflow DAG file (dag_bayam.py).
# ─────────────────────────────────────────────────────────────────────────────
...
OUTPUT_NAME = 'bayam_2'
TRANSFORMS  = json.loads('[{"type": "drop_col", "config": {"columns": ["index", "customer_id"]}}]')
