# Auto-generated Spark DAG: fixingb2
# Workflow: fixinGB2
# Generated: 2026-06-09T02:49:34.589396
...
WORKFLOW_ID = 'wf_1780973313634_j5uf'
TASKS_DEF   = json.loads('[{"task_id": "task_6784", "output_name": "fixinggb22", "transforms": [{"type": "drop_col", "config": {"columns": ["transaction_id", "product_id"]}}], "depends_on": []}]')
...
with DAG(
    ...
    catchup=False,
    tags=["etl", "spark", "generated", 'wf_1780973313634_j5uf'],
    description='',
) as dag:
    airflow_tasks = {}
