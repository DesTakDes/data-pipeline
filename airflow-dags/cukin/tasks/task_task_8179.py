...
# Task ID   : task_8179
# DAG ID    : cukin
# Output    : warehouse.cokin
# Generated : 2026-07-15T14:42:47.246601
# ─────────────────────────────────────────────────────────────────────────────
# This file contains ALL transform logic for this task.
# It is imported by the workflow DAG file (dag_cukin.py).
# ─────────────────────────────────────────────────────────────────────────────
...
OUTPUT_NAME = 'cokin'
TRANSFORMS  = json.loads('[{"type": "join_data", "config": {"joinType": "INNER JOIN", "leftCol": "store_id", "rightCol": "store_id", "rightNodeId": "n1784126505449_2_lf4w", "rightTable": "staging.market_sales_500"}}]')
