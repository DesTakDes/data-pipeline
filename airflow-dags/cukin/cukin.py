...
# Workflow  : cukin
# DAG ID    : cukin
# Generated : 2026-07-15T14:42:47.245554
# ─────────────────────────────────────────────────────────────────────────────
...
# ── Import task modules ───────────────────────────────────────────────────────
from tasks.task_task_8179 import run as run_task_8179

DAG_ID      = 'cukin'
WORKFLOW_ID = 'wf_1784126496186_wqng'
...
with DAG(
    ...
    catchup          = False,
    max_active_tasks = 4,
    tags             = ["etl", "workflow", 'wf_1784126496186_wqng'],
    description      = '',
) as dag:
    ...
    task_8179_op = PythonOperator(
        task_id             = 'task_8179',
        python_callable     = lambda **ctx: run_task_8179(
    ...
    airflow_tasks['task_8179'] = task_8179_op
