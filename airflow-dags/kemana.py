# Auto-generated Spark DAG: kemana
# Workflow: Kemana
# Generated: 2026-05-26T01:05:42.588817
...
WORKFLOW_ID = 'wf_1779757492643'
TASKS_DEF   = json.loads('[{"task_id": "task_5357", "output_name": "kaka", "transforms": [{"type": "drop_col", "config": {"columns": ["gender"]}}], "depends_on": []}]')
...
with DAG(
    ...
    catchup=False,
    tags=["etl", "spark", "generated", 'wf_1779757492643'],
    description='',
) as dag:
    airflow_tasks = {}
