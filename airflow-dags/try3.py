# Auto-generated Spark DAG: try3
# Workflow: try3
# Generated: 2026-05-26T06:31:24.909790
...
WORKFLOW_ID = 'wf_1779777038868_lu4b'
TASKS_DEF   = json.loads('[{"task_id": "task_8166", "output_name": "1", "transforms": [{"type": "drop_col", "config": {"columns": ["transaction_id", "date"]}}], "depends_on": []}]')
...
with DAG(
    ...
    catchup=False,
    tags=["etl", "spark", "generated", 'wf_1779777038868_lu4b'],
    description='',
) as dag:
    airflow_tasks = {}
