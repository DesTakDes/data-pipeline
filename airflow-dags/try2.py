# Auto-generated Spark DAG: try2
# Workflow: try2
# Generated: 2026-05-26T06:17:49.278719
...
WORKFLOW_ID = 'wf_1779776229621_rmzg'
TASKS_DEF   = json.loads('[{"task_id": "task_2063", "output_name": "1", "transforms": [{"type": "drop_col", "config": {"columns": ["index", "url"]}}], "depends_on": []}]')
...
with DAG(
    ...
    catchup=False,
    tags=["etl", "spark", "generated", 'wf_1779776229621_rmzg'],
    description='',
) as dag:
    airflow_tasks = {}
