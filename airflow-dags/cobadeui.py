# Auto-generated Spark DAG: cobadeui
# Workflow: cobadeui
# Generated: 2026-06-03T23:12:36.560469
...
WORKFLOW_ID = 'wf_1780528279346_0n2f'
TASKS_DEF   = json.loads('[{"task_id": "task_3249", "output_name": "cobadeui", "transforms": [{"type": "drop_col", "config": {"columns": ["index", "url", "zip_code"]}}, {"type": "rename_col", "config": {"renames": {"name": "nama", "city": "kota"}}}], "depends_on": []}]')
...
with DAG(
    ...
    catchup=False,
    tags=["etl", "spark", "generated", 'wf_1780528279346_0n2f'],
    description='',
) as dag:
    airflow_tasks = {}
