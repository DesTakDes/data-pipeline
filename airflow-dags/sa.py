# Auto-generated Spark DAG: sa
# Workflow: sa
# Generated: 2026-05-26T05:49:56.974864
...
WORKFLOW_ID = 'wf_1779774552874_3ive'
TASKS_DEF   = json.loads('[{"task_id": "task_5225", "output_name": "1", "transforms": [{"type": "drop_col", "config": {"columns": ["transaction_id"]}}], "depends_on": []}]')
...
with DAG(
    ...
    catchup=False,
    tags=["etl", "spark", "generated", 'wf_1779774552874_3ive'],
    description='',
) as dag:
    airflow_tasks = {}
