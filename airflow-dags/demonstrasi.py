# Auto-generated DAG: demonstrasi
# Workflow : Demonstrasi
# Generated: 2026-06-26T02:52:00.149585
...
WORKFLOW_ID = 'wf_1782441454597_35ow'
TASKS_DEF   = json.loads('[{"task_id": "task_7795", "output_name": "demo", "transforms": [{"type": "select_col", "config": {"columns": ["store_id", "product_name", "quantity", "unit_price", "total_sales"]}}, {"type": "join_data", "config": {"joinType": "LEFT JOIN", "leftCol": "store_id", "rightCol": "store_id", "rightNodeId": "n1782441470164_2_762i"}}], "depends_on": []}, {"task_id": "task_2113", "output_name": "demoman", "transforms": [{"type": "drop_col", "config": {"columns": ["location", "size", "color", "review_rating", "subscription_status", "shipping_type", "discount_applied", "previous_purchases", "promo_code_used"]}}], "depends_on": []}]')
...
with DAG(
    ...
    catchup          = False,
    max_active_tasks = 4,
    tags             = ["etl","duckdb","smart",'wf_1782441454597_35ow'],
    description      = '',
) as dag:
    airflow_tasks = {}
