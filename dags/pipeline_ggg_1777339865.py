# Auto-generated DAG: pipeline_ggg_1777339865
# Workflow: ggg
# Generated: 2026-04-28T01:31:05.138151
...
DAG_ID       = 'pipeline_ggg_1777339865'
INPUT_TABLE  = 'staging.customers_(1)'
OUTPUT_NAME  = 'dom'
WORKFLOW_ID  = 'wf_1777305920484'
TRANSFORMS   = json.loads('[{"type": "rename_col", "config": {"renames": {"gender": "sex"}}}]')
...
def run_pipeline(**context):
    ...
    temps = pg.get_records(f"""
        ...
        AND table_name LIKE '_pipeline_ggg_1777339865_step_%'
    """)
    for (t,) in temps:
